...
import com.example.coderlt.uibestpractice.fragments.ManagementFragment;
import com.example.coderlt.uibestpractice.fragments.UserFragment;
import com.example.coderlt.uibestpractice.utils.BottomNavigationViewHelper;
...
public class TechnicianNavigationActivity extends AppCompatActivity implements
    ...
    private void initViews(){
        ...
        menuItems[2]=bottomNavigationView.findViewById(R.id.manager);
        menuItems[3]=bottomNavigationView.findViewById(R.id.user);
        viewPager = findViewById(R.id.view_pager);
        fm = getSupportFragmentManager();
        fragments = new ArrayList<>();
        HomeFragment homeFragment = new HomeFragment();
        ManagementFragment orderFragment = new ManagementFragment();

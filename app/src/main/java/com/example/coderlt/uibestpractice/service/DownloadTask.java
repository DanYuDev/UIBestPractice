...
public class DownloadTask extends AsyncTask<String,Integer,Integer> {
    ...
    protected Integer doInBackground(String... params){
        ...
        try{
            ...
            if(file.exists()){
                Log.d(TAG,"file exist,file.length() is："+file.length());
    ...
    /**
     * 在界面上更新当前的下载进度，doInBackground里面执行 publishProgress(progress)
     * @param values
     */
    @Override
